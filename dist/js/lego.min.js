...
define('app/components/test',[],function() {
...
define('app/components',['require','app/components/test'],function(require) {
  return {
...
define('app/services/disclose',[],function() {
 ...
 * @author Tom Genoni
 */
define('app/directives/disclose',['app/services/disclose'],function() {
...
define('app/directives/poptip',['require','jquery'],function(require) {
  ...
  return {
    ...
    bind: function() {
      ...
      // Testing here to see if we have two values, if so only change the first.
      if ( arrowParts.length > 1) {
        ...
        // If the given direction is right, change to left.
        if (direction === "right") {
          arrowLocation = "left";
        }
      }
...
define('app/directives',['require','app/directives/accordion','app/directives/dropdown','app/directives/disclose','app/directives/poptip','app/directives/tabs','app/directives/editable_text'],function(require) {
  return {
