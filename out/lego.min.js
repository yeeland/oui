 ...
 */
define('app_factory',['require','exports','module','lodash','vue'],function(require, module, exports) {
...
define('app/components/test',['vue'],function() {
 ...
 * @author Cheston Lee
 */
define('app/directives/poptip',['require','exports','module','jquery','vue'],function(require, exports, module) {
  var $ = require('jquery');
  var Vue = require('vue');
...
define('app/directives',['require','app/directives/poptip'],function(require) {
  return {
...
define('main.js',['require','app','app_config'],function(require) {
  var app = require('app');
